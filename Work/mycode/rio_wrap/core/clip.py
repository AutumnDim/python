...
# # 假设有两个 bounds
# bounds1 = (0, 10, 10, 0)  # (left, bottom, right, top)
# bounds2 = (5, 15, 15, 5)
# bounds1 = (0, 0, 10, 10)  # (left, bottom, right, top)
# bounds2 = (5, 5, 15, 15)

# # 将 bounds 转换为 shapely 的 box 对象
# box1 = box(*bounds1)  # 创建第一个矩形
# box1.bounds
# box2 = box(*bounds2)  # 创建第二个矩形
# box2.bounds
...
# import numpy as np
# # x = np.ma.masked_equal([np.nan,2,3], 2)
# # x.mask
# src = (10, 20, 20, 10)
# dst = (1, 1, 2, 2)
# # y = np.ma.asarray([x])
...
#     intersection = box1.intersection(box2)
#     return intersection.bounds
# x = bounds_intersection(src,dst)
# np.array_equal((np.nan, np.nan, np.nan, np.nan),x)


# from rasterio.coords import disjoint_bounds

# disjoint_bounds(src, dst)
# srcx = -1
# dr = -2
# dl = 1
