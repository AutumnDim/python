...
def clean_data(data_all):
    ...
    data_all[(data_all < 0) | (data_all > 10000)] = np.nan          # 降水的无效值不统一
    return data_all
...
if __name__ == "__main__":
    ...
    path = r"C:\降水归档\降水数据插值(国内)_气象局\0气象数据\格式整理数据\unique_station_1980_2022.txt"              # 经纬度数据信息
    path_data = r"C:\降水归档\降水数据插值(国内)_气象局\0气象数据\格式整理数据\降水量\precipitation_time_2020_*.txt"  # 原始降水量数据
    output_path = r'C:\降水归档\降水数据插值(国内)_气象局\1数据缺失值概况'
